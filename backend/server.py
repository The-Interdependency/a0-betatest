    ...
    if n == 0:
        starters: list[AgentExport] = [
            AgentExport(slug="research-council", name="Research Council",
                        ...
                        default_models=["emergent:openai:gpt-5.4", "emergent:anthropic:claude-sonnet-4-6", "emergent:gemini:gemini-2.5-flash"],
            ...
            AgentExport(slug="daisy-prover", name="Daisy Prover",
                        ...
                        default_models=["emergent:openai:gpt-5.4", "emergent:anthropic:claude-sonnet-4-6"],
            ...
            AgentExport(slug="zfae-classic", name="ZFAE Classic (Φ Ψ Ω)",
                        ...
                        default_models=["emergent:openai:gpt-5.4-mini"],
